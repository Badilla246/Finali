...
@section('content')
    ...
    <div class="container">
        <div class="form">
            <div>
                ...
                <input type="number" id="food_number" min="1" max="50" class="common-input">
            </div>
            <div>
        ...
        <div class="info">
            ...
            <div class="qr-code-box">
                <img id="qrcode" src="Logo.png" alt="qrcode" >
            </div>
    ...
    <script>
        function generateQR() {
            var serialNumber = document.getElementById('food_number').value;
            ...
            var qrCodeText = "Food Number: " + serialNumber + "\nName: " + name + "\nPassword: " + password;
            ...
            // Clear form fields
            document.getElementById('food_number').value = "";
